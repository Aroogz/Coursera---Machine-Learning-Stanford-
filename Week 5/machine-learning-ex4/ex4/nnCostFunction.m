...
stage_1 = sigmoid(X*Theta1');
stage_1 = [ones(size(stage_1, 1), 1) stage_1];

stage_2 = sigmoid(stage_1*Theta2');
...
J = sum(sum(((-new_y .* log(stage_2)) - (1-new_y).*log(1-stage_2))))/m;
